/*
 * Copyright (C) 2015 The Telink Bluetooth LightRequest Project
 *
 */
...
import com.telink.crypto.util.ArraysUtils;
...
public abstract class AES {
    ...
    public static byte[] encrypt(byte[] key, byte[] content)
        ...
        key = ArraysUtils.reverse(key);
        content = ArraysUtils.reverse(content);
